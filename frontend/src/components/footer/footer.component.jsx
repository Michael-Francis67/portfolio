...
const FooterComponent = () => {
    return (
        <footer className="footer footer-center p-10 bg-base-200 mt-4 text-base-content rounded">
            <nav className="grid grid-flow-col gap-4 max-lg:hidden">
            ...
            <nav>
                <div className="grid grid-flow-col gap-4">
                    ...
                    <RouterLink target="_blank" to="https://youtube.com" className="link link-hover">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                    ...
                    <RouterLink target="_blank" to="https://github.com/Michael-Francis67" className="link link-hover">
                        <SiGithub size={24} />
                    </RouterLink>
                    <RouterLink target="_blank" to="https://github.com/Michael-Francis67" className="link link-hover">
                        <SiWhatsapp size={24} />
